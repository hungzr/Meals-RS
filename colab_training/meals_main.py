...
def define_meal_flags():
  ...
  flags_core.set_defaults(data_dir="/content/drive/My Drive/FinalProject_RecommendationSys/dataset/csv_file/",
                          model_dir='./meals_model_saved/',
                          model_type="deep",
                          train_epochs=150,
...
def run_meal(flags_obj):
  ...
  dir_path = "/content/drive/My Drive/FinalProject_RecommendationSys/dataset/csv_file/"
