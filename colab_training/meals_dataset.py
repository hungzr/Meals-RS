...
import os
import sys
sys.path.append('./drive/My Drive/FinalProject_RecommendationSys/')
...
_BUFFER_SIZE = {
    ...
    meals.FOOD: {"train": 132561000, "eval": 162811000}
}
...
def build_model_columns(dataset):
  ...
  deep_columns = [user_embedding, item_embedding, user_gender, user_age, user_hobbies, user_health, meals_embedding]
  wide_columns = []
...
def main(_):
  ...
  dir_path_colab = "/content/drive/My Drive/FinalProject_RecommendationSys/dataset/csv_file/"

  dir_path_pc = '/home/ti1070/HungDo/FinalProject_RecommendationSys/dataset/csv_file/'
  construct_input_fns("food", dir_path_pc)
