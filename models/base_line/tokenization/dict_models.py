# sys.path.append('C:/Users/HungDo/Desktop/core_nlp/tokenization')
from models.tokenization.base_tokenizer import BaseTokenizer
from models.tokenization.utils import load_n_grams
__author__ = "Ha Cao Thanh"
__copyright__ = "Copyright 2018, DeepAI-Solutions"


class LongMatchingTokenizer(BaseTokenizer):
    def __init__(self, bi_grams_path='C:/Users/HungDo/Desktop/core_nlp/tokenization/bi_grams.txt', tri_grams_path='C:/Users/HungDo/Desktop/core_nlp/tokenization/tri_grams.txt'):
        """
        Initial config
